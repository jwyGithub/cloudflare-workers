...
const l = new g(), x = {
  async fetch(n, e) {
    ...
    l.get("/", () => h()).post("/api/add", (o) => r.add(o)).delete("/api/delete", (o) => r.delete(o)).get("/api/queryByCode", (o) => r.queryByCode(o)).get("/api/queryList", (o) => r.queryList(o)).get("/:code", (o) => r.redirect(o));
    const a = await l.handle(n, e);
    return s.cors(a);
  }
};
export {
